...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(CoinWidget = new(conn));
            AddTable(DailyRewardWidgets = new(conn));
            AddTable(EnergyPanel = new(conn));
            AddTable(EnergyWidget = new(conn));
            AddTable(GemWidget = new(conn));
            AddTable(LevelSkinWidgets = new(conn));
            AddTable(LevelWidget = new(conn));
            AddTable(MagnetWidgets = new(conn));
            AddTable(PlayerMovementTrailWidgets = new(conn));
            AddTable(PlayerSkinWidgets = new(conn));
            AddTable(RevivePanel = new(conn));
            AddTable(ShieldWidgets = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.CoinWidget().ToSql(),
            new QueryBuilder().From.DailyRewardWidgets().ToSql(),
            new QueryBuilder().From.EnergyPanel().ToSql(),
            new QueryBuilder().From.EnergyWidget().ToSql(),
            new QueryBuilder().From.GemWidget().ToSql(),
            new QueryBuilder().From.LevelSkinWidgets().ToSql(),
            new QueryBuilder().From.LevelWidget().ToSql(),
            new QueryBuilder().From.MagnetWidgets().ToSql(),
            new QueryBuilder().From.PlayerMovementTrailWidgets().ToSql(),
            new QueryBuilder().From.PlayerSkinWidgets().ToSql(),
            new QueryBuilder().From.RevivePanel().ToSql(),
            new QueryBuilder().From.ShieldWidgets().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<Coins, CoinWidgetCols, CoinWidgetIxCols> CoinWidget() => new("coin_widget", new CoinWidgetCols("coin_widget"), new CoinWidgetIxCols("coin_widget"));
        public global::SpacetimeDB.Table<DailyRewards, DailyRewardWidgetsCols, DailyRewardWidgetsIxCols> DailyRewardWidgets() => new("daily_reward_widgets", new DailyRewardWidgetsCols("daily_reward_widgets"), new DailyRewardWidgetsIxCols("daily_reward_widgets"));
        public global::SpacetimeDB.Table<EnergyPanel, EnergyPanelCols, EnergyPanelIxCols> EnergyPanel() => new("energy_panel", new EnergyPanelCols("energy_panel"), new EnergyPanelIxCols("energy_panel"));
        public global::SpacetimeDB.Table<EnergyWidget, EnergyWidgetCols, EnergyWidgetIxCols> EnergyWidget() => new("energy_widget", new EnergyWidgetCols("energy_widget"), new EnergyWidgetIxCols("energy_widget"));
        public global::SpacetimeDB.Table<Gems, GemWidgetCols, GemWidgetIxCols> GemWidget() => new("gem_widget", new GemWidgetCols("gem_widget"), new GemWidgetIxCols("gem_widget"));
        public global::SpacetimeDB.Table<LevelSkinWidgetEntry, LevelSkinWidgetsCols, LevelSkinWidgetsIxCols> LevelSkinWidgets() => new("level_skin_widgets", new LevelSkinWidgetsCols("level_skin_widgets"), new LevelSkinWidgetsIxCols("level_skin_widgets"));
        public global::SpacetimeDB.Table<Level, LevelWidgetCols, LevelWidgetIxCols> LevelWidget() => new("level_widget", new LevelWidgetCols("level_widget"), new LevelWidgetIxCols("level_widget"));
        public global::SpacetimeDB.Table<MagnetWidgets, MagnetWidgetsCols, MagnetWidgetsIxCols> MagnetWidgets() => new("magnet_widgets", new MagnetWidgetsCols("magnet_widgets"), new MagnetWidgetsIxCols("magnet_widgets"));
        public global::SpacetimeDB.Table<PlayerMovementTrailWidgetEntry, PlayerMovementTrailWidgetsCols, PlayerMovementTrailWidgetsIxCols> PlayerMovementTrailWidgets() => new("player_movement_trail_widgets", new PlayerMovementTrailWidgetsCols("player_movement_trail_widgets"), new PlayerMovementTrailWidgetsIxCols("player_movement_trail_widgets"));
        public global::SpacetimeDB.Table<PlayerSkinWidgetEntry, PlayerSkinWidgetsCols, PlayerSkinWidgetsIxCols> PlayerSkinWidgets() => new("player_skin_widgets", new PlayerSkinWidgetsCols("player_skin_widgets"), new PlayerSkinWidgetsIxCols("player_skin_widgets"));
        public global::SpacetimeDB.Table<RevivePanel, RevivePanelCols, RevivePanelIxCols> RevivePanel() => new("revive_panel", new RevivePanelCols("revive_panel"), new RevivePanelIxCols("revive_panel"));
        public global::SpacetimeDB.Table<ShieldWidgets, ShieldWidgetsCols, ShieldWidgetsIxCols> ShieldWidgets() => new("shield_widgets", new ShieldWidgetsCols("shield_widgets"), new ShieldWidgetsIxCols("shield_widgets"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch {
                Reducer.ApplyCosmetic args => Reducers.InvokeApplyCosmetic(eventContext, args),
                Reducer.BanPlayer args => Reducers.InvokeBanPlayer(eventContext, args),
                Reducer.BeginAdWatch args => Reducers.InvokeBeginAdWatch(eventContext, args),
                Reducer.BeginPlaythrough args => Reducers.InvokeBeginPlaythrough(eventContext, args),
                Reducer.ClaimDailyReward args => Reducers.InvokeClaimDailyReward(eventContext, args),
                Reducer.ContinuePlaythrough args => Reducers.InvokeContinuePlaythrough(eventContext, args),
                Reducer.EndAdWatch args => Reducers.InvokeEndAdWatch(eventContext, args),
                Reducer.EndPlaythrough args => Reducers.InvokeEndPlaythrough(eventContext, args),
                Reducer.MakePurchase args => Reducers.InvokeMakePurchase(eventContext, args),
                Reducer.ManageConfig args => Reducers.InvokeManageConfig(eventContext, args),
                Reducer.PausePlaythrough args => Reducers.InvokePausePlaythrough(eventContext, args),
                Reducer.RenamePlayer args => Reducers.InvokeRenamePlayer(eventContext, args),
                Reducer.SyncTime args => Reducers.InvokeSyncTime(eventContext, args),
                Reducer.UnbanPlayer args => Reducers.InvokeUnbanPlayer(eventContext, args),
                Reducer.UsePowerUp args => Reducers.InvokeUsePowerUp(eventContext, args),
